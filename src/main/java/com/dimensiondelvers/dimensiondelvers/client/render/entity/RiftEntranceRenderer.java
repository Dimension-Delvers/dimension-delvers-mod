...
@OnlyIn(Dist.CLIENT)
public class RiftEntranceRenderer extends EntityRenderer<RiftEntranceEntity, RiftEntranceRenderer.RiftRendererEntityState> {
    ...
    public void extractRenderState(@NotNull RiftEntranceEntity entity, @NotNull RiftRendererEntityState state, float delta) {
