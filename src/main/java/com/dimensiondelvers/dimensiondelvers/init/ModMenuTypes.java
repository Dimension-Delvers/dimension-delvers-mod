...
public class ModMenuTypes {
    ...
    public static final Supplier<MenuType<AbilityBagMenu>> ABILITY_BAG_MENU =
            MENUS.register("ability_bag_menu",
                    () -> new MenuType<>((IContainerFactory<AbilityBagMenu>) AbilityBagMenu::new, FeatureFlags.DEFAULT_FLAGS));
