...
public class ModBlocks {
    ...
    public static final DeferredBlock<RuneAnvilBlock> RUNE_ANVIL_BLOCK = registerBlock("rune_anvil",
            () -> new RuneAnvilBlock(
                    BlockBehaviour.Properties.of().setId(blockId("rune_anvil")).strength(2.5F).sound(SoundType.METAL)));

    public static final DeferredBlock<RiftChestEntityBlock> RIFT_CHEST = registerBlock("rift_chest",
            () -> new RiftChestEntityBlock(
