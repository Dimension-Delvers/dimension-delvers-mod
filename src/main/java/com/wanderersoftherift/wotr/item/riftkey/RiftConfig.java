...
public record RiftConfig(int tier, Optional<Holder<RiftTheme>> theme, Optional<Integer> seed) {
    ...
    public List<Component> getTooltips() {
        ...
        result.add(Component.translatable("tooltip." + WanderersOfTheRift.MODID + ".rift_key_tier", tier).withColor(ChatFormatting.GRAY.getColor()));
        theme.ifPresent(x -> {
            ...
            result.add(Component.translatable("tooltip." + WanderersOfTheRift.MODID + ".rift_key_theme", themeName).withColor(ChatFormatting.GRAY.getColor()));
        });
        return result;
    }
}
