 ...
 * <li>3D is "Re-oriented 4-point BCC noise" which constructs a congruent BCC lattice in a much different way than
 * usual.</li>
 * <li>4D constructs the lattice as a union of five copies of its reciprocal. It successively finds the closest point on
 * each.</li>
 * </ul>
...
public class OpenSimplex2F {
    // CHECKSTYLE.OFF: code used as is from source
    ...
    // CHECKSTYLE.ON: code used as is from source
}