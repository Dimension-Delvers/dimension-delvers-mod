...
public class Modifier {
    public static final Codec<Modifier> DIRECT_CODEC = RecordCodecBuilder.create(inst -> inst
            .group(AbstractModifierEffect.CODEC.listOf().fieldOf("modifiers").forGetter(Modifier::getModifierEffects))
