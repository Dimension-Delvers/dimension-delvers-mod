...
public final class SophisticatedBackpackInterop {
    ...
    public static void register(RegisterEvent event) {
        event.register(ModContainerTypes.CONTAINER_TYPE_KEY, registry ->
                registry.register(WanderersOfTheRift.id("sophisticated_storage_backpack"), new SophisticatedBackpackType()));
    }
