...
/**
 * A render type for rift portals - these are rendered with an outline texture with a black interior that gets replaced
 * with a fixed view using a second texture
 */
