...
public class RiftEntranceRenderer
        extends EntityRenderer<RiftPortalEntity, RiftEntranceRenderer.RiftRendererEntityState> {
    ...
    public void render(RiftRendererEntityState state, PoseStack poseStack, @NotNull MultiBufferSource bufferSource,
        ...
        vertex(vertexconsumer, lastPose, packedLight, -0.5f, -0.5f, 0.0f, 0, 1);
        vertex(vertexconsumer, lastPose, packedLight, 0.5f, -0.5f, 0.0f, 1, 1);
        vertex(vertexconsumer, lastPose, packedLight, 0.5f, 0.5f, 0.0f, 1, 0);
        vertex(vertexconsumer, lastPose, packedLight, -0.5f, 0.5f, 0.0f, 0, 0);
        poseStack.popPose();
