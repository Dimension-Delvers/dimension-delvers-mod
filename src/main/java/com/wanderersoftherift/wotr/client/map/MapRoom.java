...
public class MapRoom {
    ...
    // size of the tunnel between rooms - gets subtracted from room size
    private static final float TWEEN_TUNNEL_SIZE = 0.3f;

    private static final int[][] wireEdges = { { 0, 1 }, { 1, 2 }, { 2, 3 }, { 3, 0 }, { 4, 5 }, { 5, 6 }, { 6, 7 },
            { 7, 4 }, { 0, 4 }, { 1, 5 }, { 2, 6 }, { 3, 7 } };

    private static final int[][] cubeFaces = { { 0, 1, 2, 3 }, // bottom
            { 7, 6, 5, 4 }, // top
            { 4, 5, 1, 0 }, // front
            { 6, 7, 3, 2 }, // back
            { 0, 3, 7, 4 }, // left
